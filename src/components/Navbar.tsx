        ...
        <div className="fixed top-0 left-0 right-0 z-50 flex justify-center p-6 pointer-events-none">
            ...
            >
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-bold tracking-tight">AUQÉO</span>
                </div>
                ...
                <a
                    ...
                    className="text-xs bg-white text-black px-4 py-2 rounded-full font-bold hover:scale-105 transition-all"
                >
                    Sign Up
                </a>
            </motion.nav>
